<?php
  ...
  $sucess="";
    ...
    if(isset($_POST['sign_up']))
    {
        ...
        {
              $errorFlag++;
              $error=$error."This staff account is already registered.Please login.<br>";
        }
...

        {
            ...
            INSERT INTO `staff` (`staff_id`,`password`) VALUES ('$id','$password')
            LIMIT 1
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">You can:</h6>
            <a class="collapse-item active" href="createStaff.php"><i class="fas fa-user-check"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h1 class="h3 mb-2 text-gray-800 text-center">Create Account</h1>
          <p class="mb-4 text-center">Fill the information below to create a staff account.</p>
    ...
    <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-5 pr-lg-5" style="margin-bottom: 1rem;">
            ...
            <div class="display-4 text-center mb-3 mr-5 text-center" style="font-size:35px; margin-left:0.7em;">Create an Account</div>
            ...
            <form action="#" method="POST">
                <div class="row">
                    ...
                    <div class="input-group col-lg-8 mx-auto mb-4">
                        ...
                        <input id="passwordconf" type="password" name="password_conf" placeholder="Confirm Password" class="form-control bg-white border-left-0 border-md">
                    </div>

                    <!-- Submit Button -->
                    <div class="form-group col-lg-5 mx-auto mb-0" style="margin-top: 5px;">
                        <button type="submit" class="btn btn-primary btn-block py-2" name="sign_up">
